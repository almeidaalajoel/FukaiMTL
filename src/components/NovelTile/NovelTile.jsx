...
export default function NovelTile({ title, description, image, author, link }) {
  return (
    <>
      <Link href={link}>
        <div className="flex flex-col w-[24rem] flex-grow px-4 hover:cursor-pointer font-['ProximaNova'] leading-6 rounded-2xl items-center sm:flex-row  sm:justify-evenly sm:w-[38rem] md:w-[50rem] lg:w-[64rem] dark:bg-[rgb(21,19,19)]">
