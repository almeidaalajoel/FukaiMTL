...
export default function NovelTile({ title, description, image, author, link }) {
  return (
    <Link href={link}>
      <div className="flex flex-col w-full flex-grow hover:cursor-pointer font-['ProximaNova'] leading-6 items-center sm:flex-row sm:justify-evenly dark:bg-[rgb(21,19,19)] px-8 sm:px-10">
