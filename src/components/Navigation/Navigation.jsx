...
export default function Navigation({ TOClink, prevURL, nextURL }) {
  const nextPrev =
    "flex border-solid border-4 border-[rgb(70,70,70)] hover:border-black hover:text-black dark:border-gray-300  dark:hover:border-white dark:hover:text-white dark:hover:bg-[rgb(28,25,25)] w-1/4 h-[3rem] rounded-2xl items-center justify-center select-none hover:cursor-pointer";

  const noNextPrev =
    "flex border-solid border-4 border-[rgb(180,180,180)] text-[rgb(180,180,180)] dark:border-gray-700 dark:text-gray-700  w-1/4 h-[3rem] rounded-2xl items-center justify-center select-none";
